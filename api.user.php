	...
	switch ($_POST['calling']) {
		case 'user':
			switch ($_POST['action']) {
				case 'register':
					if(true){
						$user_id = $user->register($_POST['code'],$_POST['fname'],$_POST['lname'],$_POST['password']);
				...
				case 'edit':
					if(true){
						$user_id = $user->editInfo($_POST['id'],$_POST['code'],$_POST['fname'],$_POST['lname'],$_POST['password']);
