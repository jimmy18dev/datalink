			...
			switch ($_POST['action']) {
				case 'create':
					if(true){
						...
						$useractivity->saveActivity($user->id,'CreateRemark',$_POST['description'],$return_id);
				...
				case 'edit':
					if(true){
						...
						$useractivity->saveActivity($user->id,'EditRemark','Change message "'.$_POST['description'].'"',$_POST['id']);
