<header class="header">
	...
	<a href="profile.php" class="header-items user-items <?php echo ($current_page['1'] == 'profile'?'header-items-active':'');?>"><i class="fa fa-user" aria-hidden="true"></i><?php echo $user->fname;?></a>
</header>