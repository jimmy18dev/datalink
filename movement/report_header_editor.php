...
<header class="form-bar">
	<a href="index.php" class="discard-btn"><i class="fa fa-times" aria-hidden="true"></i>Discard</a>
	...
	<?php }else{?>
	<button class="btn" onclick="javascript:editHeaderReport(<?php echo $report->id;?>);">Update<i class="fa fa-check" aria-hidden="true"></i></button>
	<?php }?>
</header>
<div class="form-container">
	<div class="form-title">
		<div class="caption">Creating a report for: </div>
		<div class="input">
	...
	<div class="form-section">
		...
		<div class="inputs">
			<div class="section-items">
				<div class="input"><input type="number" class="input-text" id="no_monthly_emplys" placeholder="0" value="<?php echo ($report->no_monthly_emplys>0?$report->no_monthly_emplys:'');?>"></div>
				<div class="caption">Monthly Prs</div>
			</div>
			<div class="section-items">
				<div class="input"><input type="number" class="input-text" id="ttl_monthly_hrs" placeholder="0.00" value="<?php echo ($report->ttl_monthly_hrs>0?$report->ttl_monthly_hrs:'');?>"></div>
	...
	<div class="form-section">
		...
		<div class="inputs">
			<div class="section-items">
				<div class="input"><input type="number" class="input-text" id="no_daily_emplys" placeholder="0" value="<?php echo ($report->no_daily_emplys>0?$report->no_daily_emplys:'');?>"></div>
				<div class="caption">Daily Prs</div>
			</div>
			<div class="section-items">
				<div class="input"><input type="number" class="input-text"  id="ttl_daily_hrs" placeholder="0.00" value="<?php echo ($report->ttl_daily_hrs>0?$report->ttl_daily_hrs:'');?>"></div>
				<div class="caption">Normal Hrs.</div>
			</div>
		</div>
	</div>
