...
<div class="report-header-items <?php echo ($new_items?'last-items':'');?>">
	...
	<div class="col6" title="<?php echo $var['fname'].' '.$var['lname'];?> (<?php echo $var['user_code'];?>)"><?php echo $var['fname'];?></div>
	<div class="col7"><span class="time" title="<?php echo $var['updated'];?>"><?php echo $var['update'];?></span> <i class="fa fa-angle-right"></i></div>
</div>
</a>