...
<a href="report_detail_editor.php?caliber=<?php echo $var['caliber_id'];?>&header=<?php echo $header_id;?>&action=create" class="caliber-choose-items"><strong><?php echo $var['caliber_code'].' '.$var['caliber_family'];?></strong> : Std.time <?php echo $var['caliber_stdtime'];?> <span class="ttl_operation">(<?php echo $var['total_operation'];?> operations)</span><i class="fa fa-angle-right" aria-hidden="true"></i>
</a>
<?php }else{?>
